...
MySQL - 8.0.23 : Database - gulimall_ums
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gulimall_ums` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `ums_member_level` (
  ...
  `note` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='会员等级';

/*Data for the table `ums_member_level` */

insert  into `ums_member_level`(`id`,`name`,`growth_point`,`default_status`,`free_freight_point`,`comment_growth_point`,`priviledge_free_freight`,`priviledge_member_price`,`priviledge_birthday`,`note`) values (1,'普通会员',0,0,'299.0000',10,0,0,1,'普通会员'),(2,'铜牌会员',3000,0,'100.0000',10,0,0,1,'铜牌会员'),(3,'银牌会员',5000,0,'100.0000',20,0,1,1,'银牌会员'),(4,'金牌会员',8000,0,'0.0000',40,1,1,1,'金牌会员');
